...
os.system('git pull')
os.system('clear')
print('[\033[1;32m✓\033[1;37m] Tool RXS Update Done')
print('[\033[1;32m✓\033[1;37m] Now You Can Enjoy Tool RXS(^,^) ')
time.sleep(2)
...
\033[1;31m One line Command:\nsudo python WifiHack/binod.py -i wlan0 -K\n
\033[1;31m For Help Type:\npython WifiHack/binod.py --help\033[0m
